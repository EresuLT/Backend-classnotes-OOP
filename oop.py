...
emp1 = Employee("Resul", 27, "FS", ["python", "JS"])
# print(emp1)
...
#     class Meta:    # standart isim bu şekilde değişmez. Classın ayarlarını yapmış olduk. ordering ile isme göre sırala dedik...
#         ordering = ["name"]


# print(Employee.mro())   # Output : [<class '__main__.Employee'>, <class '__main__.Person'>, <class '__main__.Lang'>, <class 'object'>]
# nereden geldi üredi ...
...
# bir classtan yeni bir class oluşturma = inheritance
